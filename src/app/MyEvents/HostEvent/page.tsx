...
export default function HostEvent() {
  //we need to make this a hook we can grab the values that we are using in the return and return them in the hook to hook onto this component
  //we could then modulize the ui if needed
